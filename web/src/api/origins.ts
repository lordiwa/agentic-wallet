 ...
 *
 * **Copia literal de `panel/src/api/origins.ts`.** El panel (Vue) y este
 * dashboard (React) son dos workspaces distintos, sin un paquete compartido
 * entre ellos; el proyecto ya decidio que entre esos dos el codigo se copia y
 * no se abstrae (docs/wargaming-simplificacion.md §3.4, riesgo 6). Si cambia
 * la politica, cambia en los dos archivos — y los dos tienen su test.
 *
